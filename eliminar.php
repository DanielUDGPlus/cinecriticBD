...
<head>
  <meta charset="UTF-8">
  <title>Eliminar Películas - Cinecritic</title>
...
<body>
  <div class="container">
    ...
    <main>
      <h2 style="text-align:center;">Selecciona películas para eliminar</h2>
      <form action="procesar_eliminar.php" method="post">
          ...
          <?php foreach ($peliculas as $pelicula): ?>
            <div class="juego-card">
              ...
              <div class="eliminar-checkbox">
                <label>
                  <input type="checkbox" name="eliminar_ids[]" value="<?= $pelicula['id'] ?>">
                  Eliminar
                </label>
              </div>
            </div>
        ...
        <button type="submit" class="boton-eliminar-seleccionados">Eliminar seleccionados</button>
      </form>
    </main>
